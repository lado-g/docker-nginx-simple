  ...
  stages {
    ...
    post {
        success {
          ...
          snsPublish (topicArn:snsArn, subject: "Jenkins job", message: 'Jenkins Job $JOB_NAME finished succesfully')
          
        }
        failure {
          
          snsPublish (topicArn:snsArn, subject: "Jenkins job", message: 'Jenkins Job $JOB_NAME finished with errors')
