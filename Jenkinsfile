  ...
  stages {
    ...
    post {
        success {
          ...
          snsPublish (topicArn:snsArn, subject: "Jenkins job", message: 'Jenkins Job  finished succesfully')
          
        }
        failure {
          
          snsPublish (topicArn:snsArn, subject: "Jenkins job", message: 'Jenkins Job  finished with errors')
